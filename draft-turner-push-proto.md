...
Since WebPush is not a data carrying system, there are a few things developers
should keep in mind.
...
It is RECOMMENDED that Endpoints simply be a prefix followed by the channelID or
